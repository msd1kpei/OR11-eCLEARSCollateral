...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  <mapSources>
    <source type="XSD">
      <schema location="../xsd/e-CLEARSCollateral-response.xsd"/>
      <rootElement name="kpeiInbound" namespace="http://www.kpei.co.id/razor/e-CLEARSCollateral"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="XSD">
  ...
  <mapGenType type="REQNIL"/>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.4.0(build 110106.1932.5682) AT [THU SEP 29 10:28:39 ICT 2011]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://www.kpei.co.id/razor/e-CLEARSCollateral"
                    ...
                    <xsl:for-each select="ns0:trade/ns0:extensions/ns0:extension">
                      <xsl:if test='oraext:compare-ignore-case(../../ns0:tradeHeader/ns0:tradeType,"collbond") = 0.0'>
                        <ns0:extension>
                          ...
                          <xsl:variable name="v"
                                        select='oraext:lookup-table("BOND_PRICE","BOND_CODE",ns0:value,"PRICE","jdbc/ds_kpeimid")'/>
                          <xsl:choose>
